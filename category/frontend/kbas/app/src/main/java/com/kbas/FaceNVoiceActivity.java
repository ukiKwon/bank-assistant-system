...
public class FaceNVoiceActivity extends AppCompatActivity {
    ...
    public void setConfig() {
        mCameraTextureView = (TextureView) findViewById(R.id.fc_textureview);

    }
    public void faecOptionExamples() {
